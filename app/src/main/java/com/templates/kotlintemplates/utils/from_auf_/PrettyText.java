...
/**
 * PrettyText is a TextView which lets you customize the styling of parts of your text via
 * Spannables, but without the hassle of having to deal directly with Spannable themselves.
 * <p/>
 * The idea behind a PrettyText is that it is made up of {@code Piece}s. Each Piece represents a
...
public class PrettyText extends TextView {
    ...
    private void init() {
        ...
        PrettyText.DEFAULT_ABSOLUTE_TEXT_SIZE = (int) getTextSize();
    }

    /**
     * Use this method to add a {@link Piece} to a PrettyText.
     ...
     * PrettyText to display "Hello World" such that "Hello" is displayed in Bold and "World" is
